  ...
  <div class="content">
    <form id="configForm" novalidate>
      ...
      <details class="section" id="section-clock">
        ...
        <div class="row" data-setting="timeeffects">
          <label for="timeeffects">Time effects</label>
          <select id="timeeffects" name="timeeffects">
            <option value="0">Off</option>
            <option value="1">Crossfade</option>
            <option value="2">Rolling 1</option>
            <option value="3">Rolling 2</option>
            <option value="4">Rolling 3</option>
          </select>
        </div>
