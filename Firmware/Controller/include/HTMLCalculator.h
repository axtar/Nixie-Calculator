...
<body>
  ...
  <div class="content">
    ...
    <div class="footer-row">
      ...
      <button id="toggleRegistersButton" class="mode-button" onclick="toggleRegisters()">Registers</button>
    </div>
  </div>
  <script>
    ...
    function toggleRegisters() {
      ...
      document.getElementById('toggleRegistersButton').classList.toggle('active', visible);
      if (websocket && (websocket.readyState === WebSocket.OPEN)) {
