...
// settings related enums and definitions
...
namespace setting_id
{
  ...
  enum setting_id
  {
    ...
    timeeffects,     // Time digit effects
    ...
    timecolor2,      // RGB LED color for time in clock mode, dual time
    ...
    dstweek2,        // Dual time daylight saving time change, week of month
    dstdow2,         // Dual time daylight saving time change, day of week
    dstmonth2,       // Dual time daylight saving time change, month
    dsthour2,        // Dual time daylight saving time change, hour
    dstoffset2,      // Dual time daylight saving time change, offset to UTC in minutes
    stdweek2,        // Dual time standard time change, week of month
    stddow2,         // Dual time standard time change, day of week
    stdmonth2,       // Dual time standard time change, month
    stdhour2,        // Dual time standard time change, hour
    stdoffset2,      // Dual time standard time change, offset to UTC in minutes
...
namespace calc_input_direc
{
  enum calc_input_direc
  {
    ltr,
    rtl,
    rtl_zero_padding
...
namespace trig_color_change
{
  enum trig_color_change
  {
    off,
    every_second,
    every_minute,
