...
Free Heap: 245000
#### Changes
- Added a new clock mode that also displays hundredths of a second
- Added new settings for LED lighting brightness
---
### Version: 0.11.1
Status:    Beta<br/>
...
Free Heap: 245000
#### Comments
Needs keyboard firmware 0.10.0 or later
#### Changes
- Keyboard communication now takes place entirely via I2C and uses the KINT line to signal data availability, as originally intended.
- Added some digit transition effects for the time display.
---
### Version: 0.9.9
Status:    Beta<br/>
Date:      September 15, 2026<br/>
...
Free Heap: 247000
#### Changes
- Moved from bit banging to SPI for faster shift register transfer
---
### Version: 0.9.7
Status:    Beta<br/>
...
Free Heap: 247000
#### Changes
- Added information about heap fragmentation to the status page
- Changes made to reduce heap fragmentation, as the firmware should support continuous operation
---
### Version: 0.9.6
Status:    Beta<br/>
Date:      September 8, 2026<br/>
ESP-IDF:   v5.5.5<br/>
Arduino:   v3.3.11<br>
Free Heap: 247000
#### Changes
- Added rounding mode option (5/4 or cut)
- Enhanced look & feel of the web interface
---
### Version: 0.9.5
Status:    Beta<br/>
Date:      September 6, 2026<br/>
ESP-IDF:   v5.5.5<br/>
Arduino:   v3.3.11<br>
Free Heap: 247000
#### Changes
- Added more lighting effects
---
### Version: 0.9.4
Status:    Beta<br/>
...
Free Heap: 246000
#### Changes
- Added "Calculator" page for device mirroring
