...
public:
  Settings()
  {
    ...
    _settings[setting_id::timeeffects] = new Setting(setting_id::timeeffects, "timeeffects",
        setting_type::numeric, time_effects::off, time_effects::off, time_effects::rolling3,
        syncToCache<&SettingsCache::timeEffects>, syncFromCache<&SettingsCache::timeEffects>);
