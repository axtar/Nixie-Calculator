...
// allows fast access to the current values of the settings
...
public:
  ...
  inline static SCHEDULETIME offStartTime;
  inline static SCHEDULETIME offStopTime;
  inline static int offDays;
  ...
  inline static digit_transition::digit_transition digitTransition;
  ...
  inline static trig_color_change::trig_color_change trigColorChange;
  inline static SCHEDULETIME ledStartTime;
  inline static SCHEDULETIME ledStopTime;
  inline static SCHEDULETIME ledStartTime2;
  inline static SCHEDULETIME ledStopTime2;
  inline static SCHEDULETIME acpStartTime;
  ...
  inline static timezoneRule dstRule;
  inline static timezoneRule stdRule;
  inline static timezoneRule dstRule2;
  inline static timezoneRule stdRule2;
  ...
  inline static rounding_mode::rounding_mode roundingMode;
  ...
  inline static int rtcDriftCorr;
  inline static int extTempCorr;
};