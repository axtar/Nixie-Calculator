...
private:
  ...
  // advance the color wheel hue and the breathing phase by one step
  ...
  // redraw the previously cached base colors
  ...
  void setCalcLighting()
  {
    ...
    else
    {
      ...
      // recompute colors on a real content change or every tick
