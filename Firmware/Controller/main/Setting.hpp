...
public:
  ...
  // copy this setting's value into its matching SettingsCache field(s)
  void toCache()
  {
    if (_toCache)
    {
  ...
  // copy this setting's value back from its matching SettingsCache field(s)
  void fromCache()
  {
    if (_fromCache)
    {
...
private:
  ...
  bool _modified;
  bool _hidden;
  SettingSync _toCache;
  SettingSync _fromCache;
};