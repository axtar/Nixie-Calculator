...
public:
  ...
  bool process(TimeElements *tm, TimeElements *tm2)
  {
  ...
  // return current time
  void getCurrentTime(TimeElements *tm, TimeElements *tm2) const
  {
    time_t utc, local;
    utc = now();
...
private:
  ...
  Timezone *_timeZone;
  // TimeChangeRule _dstRule2{"DST", Last, Sun, Mar, 2, 0};
  // TimeChangeRule _stdRule2{"STD ", Last, Sun, Oct, 3, 0};
  ...
  void setTimeZones()
  {
    ...
    _timeZone2->setRules(SettingsCache::dstRule2, SettingsCache::stdRule2);
  }
  ...
  void displayTime(TimeElements *tm, TimeElements *tm2)
  {
  ...
  void showDualTime(TimeElements *tm, TimeElements *tm2) const
  {
    _displayHandler->showTime(tm, 0, SettingsCache::hourMode, SettingsCache::leadingZero, true, true, SettingsCache::timeSeparator);
    _displayHandler->showTime(tm2, 10, SettingsCache::hourMode, SettingsCache::leadingZero, false, false, SettingsCache::timeSeparator, true);
  }
