...
public:
  Settings()
  {
    ...
    _settings[setting_id::dstweek2] = new Setting(setting_id::dstweek2, "dstweek2", setting_type::numeric, week_t::Last, week_t::Last, week_t::Fourth);
    _settings[setting_id::dstdow2] = new Setting(setting_id::dstdow2, "dstdow2", setting_type::numeric, dow_t::Sun, dow_t::Sun, dow_t::Sat);
    _settings[setting_id::dstmonth2] = new Setting(setting_id::dstmonth2, "dstmonth2", setting_type::numeric, month_t::Mar, month_t::Jan, month_t::Dec);
    ...
    _settings[setting_id::stdweek2] = new Setting(setting_id::stdweek2, "stdweek2", setting_type::numeric, week_t::Last, week_t::Last, week_t::Fourth);
    _settings[setting_id::stddow2] = new Setting(setting_id::stddow2, "stddow2", setting_type::numeric, dow_t::Sun, dow_t::Sun, dow_t::Sat);
    _settings[setting_id::stdmonth2] = new Setting(setting_id::stdmonth2, "stdmonth2", setting_type::numeric, month_t::Oct, month_t::Jan, month_t::Dec);
  ...
  void updateCache()
  {
    ...
    strcpy(SettingsCache::dstRule2.abbrev, "DST");
    ...
    strcpy(SettingsCache::stdRule2.abbrev, "STD");
