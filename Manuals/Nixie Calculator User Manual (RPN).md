...
In clock modes (0-9) press the [CLS] key. A blinking zero indicates that you can enter the date and the time in the YYYYMMDDhhmmss format. The [←] key deletes the last entered digit. Press [ENT] to confirm or [CLS] to abort.
